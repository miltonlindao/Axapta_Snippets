/*
Considerations:
- In the following class we wanted to access PRIVATE properties of a class through an extension, this is not supported by the compiler so we had to resort to reflection techniques
...
using System.Reflection; //Must be to implement reflection
